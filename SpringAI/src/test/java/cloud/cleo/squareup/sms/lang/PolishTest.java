...
public class PolishTest extends AbstractSmsLanguageTest {

    private final static Pattern YES = Pattern.compile("(tak |tak,)", Pattern.CASE_INSENSITIVE | Pattern.UNICODE_CASE);
    ...
    protected String getWhenDidStoreOpen() {
        return "W którym roku otwarto ten sklep po raz pierwszy?";
    }
