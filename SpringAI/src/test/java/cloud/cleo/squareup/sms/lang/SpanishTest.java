...
public class SpanishTest extends AbstractSmsLanguageTest {

    private final static Pattern YES = Pattern.compile("(si |sí |si,|sí,|sí!|si!)", Pattern.CASE_INSENSITIVE | Pattern.UNICODE_CASE);
